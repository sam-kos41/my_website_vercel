        ...
        <div className="container mx-auto">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white shadow-lg rounded-lg p-6">
                <ImageCarousel image="/images/chatbot1.jpg" /> {/* Example of a local image */}
              ...
              <div className="bg-white shadow-lg rounded-lg p-6">
                <ImageCarousel image="/images/thematic1.jpg" /> {/* Example of a local image */}
              ...
              <div className="bg-white shadow-lg rounded-lg p-6">
                <ImageCarousel image="/images/bigdata1.jpg" /> {/* Example of a local image */}
          ...
          <div className="mb-16">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6 mx-auto max-w-2xl">
              <ImageCarousel image="/images/gesture1.jpg" /> {/* Example of a local image */}
