        ...
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="border-b-2 border-gray-200 py-4">
              <h3 className="text-2xl font-semibold cursor-pointer" onClick={() => toggleAccordion(0)}>
                Big Data Analytics to Advance Understanding of Pediatric Mental and Behavioral Healthcare
              </h3>
              <div className={`overflow-hidden transition-all duration-500 ease-in-out ${activeIndex === 0 ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}>
            ...
            {/* Project 2 */}
            <div className="border-b-2 border-gray-200 py-4">
              <h3 className="text-2xl font-semibold cursor-pointer" onClick={() => toggleAccordion(1)}>
                Investigating Human-AI Interaction: Bayesian Statistics and Thematic Analysis Approaches
              </h3>
              <div className={`overflow-hidden transition-all duration-500 ease-in-out ${activeIndex === 1 ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}>
                <p className="text-lg font-light text-gray-700 mt-4">
            ...
            {/* Project 3 */}
            <div className="py-4">
              <h3 className="text-2xl font-semibold cursor-pointer" onClick={() => toggleAccordion(2)}>
                Exploring Linguistic Differences in Intuitive Gesture Elicitation for 3D Gestural Systems
              </h3>
              <div className={`overflow-hidden transition-all duration-500 ease-in-out ${activeIndex === 2 ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'}`}>
                <p className="text-lg font-light text-gray-700 mt-4">
